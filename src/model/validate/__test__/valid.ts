...
it('getError', () => {
    ...
    expect(valid.getError('maxLength', {})).toEqual('不能大于个字符')
    expect(
        valid.getError('maxLength', {
            name: '用户名',
            limit: 12
        })
    ).toEqual('用户名不能大于12个字符')
})
...
it('maxLength', () => {
    ...
    expect(valid.maxLength(4)(1234)).toEqual(false)
    expect(valid.maxLength(4, true)(1234)).toEqual(true)
    expect(valid.maxLength(4)('12345')).toEqual('不能大于4个字符')
})

it('minLength', () => {
    expect(valid.minLength(0, true)()).toEqual(true)
    expect(valid.minLength(0, true)('')).toEqual(true)
    expect(valid.minLength(1, true)('字')).toEqual(true)
    expect(valid.maxLength(4)(1234)).toEqual(false)
    expect(valid.maxLength(4, true)(1234)).toEqual(true)
